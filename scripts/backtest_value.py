...
def score_and_recommend(prace, use_strike, table):
    ...
    # Experience shrink: shipped in production (scrape_races.py, EXPERIENCE_K)
    # but previously missing here, which let this tool score every runner
    # more confidently than production ever does — see backtest-shipping
    # discipline note on the 2026-08-17 review that caught this.
    for run in runners:
